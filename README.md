<title>디폴트숙제-심우영</title>
	...
	<a href="defaulthw.html"><button onclick="chang();">2.고양이</button></a>
	<a href="wrong.html"><button onclick="nono();">3.캥거루</button></a>
	<a href="wrong.html"><button onclick="nono();">4.다람쥐</button></a>
	<a href="wrong.html"><button onclick="nono();">5.모름</button></a>
	</body>
